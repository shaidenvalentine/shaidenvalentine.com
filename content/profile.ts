...
export const profile: Profile = {
  ...
  mission:
    "I see life as a game — the highest-stakes, most beautiful one there is — and I've decided to play mine all the way to the edges. Not for the score, but for the experience: a life full of connection, purpose, and fun, lived to the absolute maximum. I build companies and back founders because creating is the most alive I ever feel — and because the whole point of getting good at any of it is to leave the world better than I found it, and help others live theirs full-out too.",
  bio: [
